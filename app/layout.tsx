...
export const metadata: Metadata = {
  title: "Amber Derr Editorial — Executive Editing for Leaders Who Can't Afford to Sound Generic",
  description:
  ...
  keywords:
    "executive editor,book editor,copy editor,business nonfiction editor,AI content editing,voice preservation,manuscript editing,Amber Derr Editorial",
  openGraph: {
    title: "Amber Derr Editorial — Executive Editing",
    description:
